...
export const DatePickerTableCell = (props: DatePickerTableCellProps) => {
  ...
  return (
    <DatePickerPrimitive.TableCell
      class={cn(
        "aria-selected:bg-accent aria-selected:text-accent-foreground aria-selected:has-[[data-outside-range]]:bg-accent/50 flex-1 p-0 text-center text-sm aria-selected:first-of-type:rounded-l-md aria-selected:last-of-type:rounded-r-md",
        local.class,
      )}
      {...rest}
    />
...
export const DatePickerInput = (props: DatePickerInputProps) => {
  ...
  return (
    <DatePickerPrimitive.Control class="border-input bg-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-9 w-full rounded-md border px-3 py-1 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-[1.5px] disabled:cursor-not-allowed disabled:opacity-50">
      <DatePickerPrimitive.Input
        ...
        {...rest}
      />
      <DatePickerPrimitive.Trigger class="focus-visible:ring-ring transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="mx-1 h-4 w-4"
          viewBox="0 0 24 24"
