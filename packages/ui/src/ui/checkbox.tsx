  ...
  return (
    <>
      ...
      <CheckboxPrimitive.Control
        class={cn(
          "border-primary focus-visible:ring-ring data-[checked]:bg-primary data-[checked]:text-primary-foreground h-4 w-4 shrink-0 rounded-[4px] border shadow transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px] data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
          local.class,
        )}
        {...rest}
      >
